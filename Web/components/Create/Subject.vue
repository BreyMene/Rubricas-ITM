...
<template>
  <div>
    <UButton size="xl" @click="isOpen = true" class="rounded-xl bg-Dark-Blue dark:bg-Dark-Grey hover:bg-Medium-Blue hover:dark:bg-Medium-Gray">
          ...
          <div class="flex flex-col md:flex-row gap-9">  
            <div class="md:w-2/5 space-y-7">
              ...
              <UFormGroup label="Agregar Docente">
                <UInput size="sm" placeholder="ejemplo@itm.edu.co" class="w-full"
                :ui="{
                    icon: {
                          trailing: { pointer: '' }
                    },
